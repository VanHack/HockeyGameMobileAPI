...
public class CheckinDTOPaginado {
	
	private Collection<CheckinDTO> itens;
	...
	public CheckinDTOPaginado() {
	}
	
	public CheckinDTOPaginado(long quantidadeRegistros, int paginaDesejada, int tamanhoPagina, Collection<CheckinDTO> itens) {
		super();
	...
	public Collection<CheckinDTO> getItens() {
		return itens;
	}

	public void setItens(Collection<CheckinDTO> itens) {
		this.itens = itens;
	}

	@SuppressWarnings("unused")
	private boolean isListEqual(final List<CheckinDTO> a, final List<CheckinDTO> b) {
		if (a == b || a.equals(b))
			return true;

		final Iterator<CheckinDTO> ia = a.iterator();
		final Iterator<CheckinDTO> ib = b.iterator();
	...
	@SuppressWarnings("unused")
	private int listHashCode(final List<CheckinDTO> a) {
		int result = 0;
		for (Iterator<CheckinDTO> iterator = a.iterator(); iterator.hasNext();) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CheckinDTOPaginado other = (CheckinDTOPaginado) obj;
		if (itens == null) {
			if (other.itens != null)
				return false;
