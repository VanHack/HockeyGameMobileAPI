...
public class RankingDTOPaginado {
	
	private Collection<RankingDTO> itens;
	...
	public RankingDTOPaginado() {
	}
	
	public RankingDTOPaginado(long quantidadeRegistros, int paginaDesejada, int tamanhoPagina, Collection<RankingDTO> itens) {
		super();
	...
	public Collection<RankingDTO> getItens() {
		return itens;
	}

	public void setItens(Collection<RankingDTO> itens) {
		this.itens = itens;
	}

	@SuppressWarnings("unused")
	private boolean isListEqual(final List<RankingDTO> a, final List<RankingDTO> b) {
		if (a == b || a.equals(b))
			return true;

		final Iterator<RankingDTO> ia = a.iterator();
		final Iterator<RankingDTO> ib = b.iterator();
	...
	@SuppressWarnings("unused")
	private int listHashCode(final List<RankingDTO> a) {
		int result = 0;
		for (Iterator<RankingDTO> iterator = a.iterator(); iterator.hasNext();) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RankingDTOPaginado other = (RankingDTOPaginado) obj;
		if (itens == null) {
			if (other.itens != null)
				return false;
