...
public class ResultGeocoding {
	...
	public void setResults(List<GeoLocationResultEntry> results) {
	...
	public class AddressGeometry {
		...
		public void setLocation(AddressGeometryLocation location) {
			this.location = location;
		}

		public void setViewport(AddressGeometryViewport viewport) {
	...
	public class AddressGeometryViewport {
		...
		public void setNortheast(AddressGeometryLocation northeast) {
			this.northeast = northeast;
		}

		public void setSouthwest(AddressGeometryLocation southwest) {
